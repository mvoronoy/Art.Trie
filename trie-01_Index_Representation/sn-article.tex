...
\title[Using Trie Data Structure for Highly Efficient Database Index Representation]{Using Trie Data Structure for Highly Efficient Database Index Representation}
...
commonly referred to as adaptive Tries or Adaptive Radix Trees (ART) \cite{leis2013adaptive}.
...
the existing children, eliminating all (nil) entries present in full
lookup tables.
...
\begin{figure}[h]
    ...
    \caption{Compressed array}\label{fig:bitmapAndArray}
\end{figure}
